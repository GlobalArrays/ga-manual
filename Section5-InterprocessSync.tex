...
Both \texttt{\noun{ga\_create\_mutexes}} and \texttt{\noun{ga\_destroy\_mutexes}}
...
to GA operations called after \texttt{\noun{ga\_init\_fence}} complete.

\texttt{\noun{ga\_fence}} must be called after \texttt{\noun{ga\_init\_fence}}.
A barrier, \texttt{\noun{ga\_sync}}, assures completion of all data
transfers and implicitly cancels outstanding ga\_init\_fence. \texttt{\noun{ga\_init\_fence}}
and \texttt{\noun{ga\_fence}} must be used in pairs, multiple calls
to \texttt{\noun{ga\_fence}} require the same number of corresponding
\texttt{\noun{ga\_init\_fence}} calls. \texttt{\noun{ga\_init\_fence/ga\_fence}}
pairs can be nested.

\textit{\underbar{Example 1:}}

Since \texttt{\noun{ga\_put}} might return before the data reaches
the final destination \texttt{\noun{ga\_init\_fence}} and \texttt{\noun{ga\_fence}}
...
\texttt{\noun{ga\_fence}} works for multiple GA operations.
\begin{lyxcode}
call~ga\_init\_fence()~
