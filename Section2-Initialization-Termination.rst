...
Starting with the GA 5.9 release, there is an additional option that allows
...
#. Creating global arrays with additional properties. This method creates a 
global array handle, assigns properties to the handle and then allocates the array.
This approach was implemented to provide an extensible method for supporting
multiple additional properties of global arrays. Refer to the
“Creating Arrays - II” section for more information on using this interface.
